//References: https://github.com/gabrielweyer/cake-build

#module nuget:?package=Cake.DotNetTool.Module&version=0.3.0

#tool dotnet:?package=GitVersion.Tool&version=5.0.0-beta3-4
#tool dotnet:?package=dotnet-xunit-to-junit&version=1.0.2
...
var solutionPath = "NetCasbin.sln";
...
Task("Test")
    ...
    .Does(() =>
    {
        ...
        settings.Framework = "netcoreapp2.2";
        settings.ResultsDirectory = testsResultsDir;

        DotNetCoreTest("./NetCasbin.UnitTest", settings);
    })
    .Does(() =>
    {
